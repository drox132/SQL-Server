/*1.ColumnStore Indexes NONClustered*/
...
--DROP INDEX IX_TBLVENTAS_DETALLE ON TBLVENTAS_DETALLE
...
--CREATE NONCLUSTERED COLUMNSTORE INDEX IX_TBLVENTAS_DETALLE ON tblVentas_Detalle (CANTIDAD,VALOR,COSTO)
